	...
	<section id="blog">
		...
		<div class="container">
			...
			<div class="resume-skills">
				...
				<h2><?php _e( 'We are sorry but this isn\'t your Provider.', 'themesdojo' ); ?></h2>
				...
				<form id="wpjobus-add-company" type="post" action="" >
					...
					<h1 class="resume-section-title"><i class="fa fa-briefcase"></i><?php _e( 'Edit Provider Profile', 'themesdojo' ); ?></h1>
					<h3 class="resume-section-subtitle" style="margin-bottom: 0;"><?php _e( 'Hey. It’s easier than it looks. Take a deep breath and complete the fields below. You’ll have a beautiful provider page!', 'themesdojo' ); ?></h3>
