...
***************************************/
	...
	function display_wpjobus_resume_basic_settings ($post) {
		...
		function display_wpjobus_resume_contact_settings ($post) {
			...
			$wpjobus_resume_booking_calendar = get_post_meta($post->ID, 'wpjobus_resume_booking_calendar',true);
		...
		<div id='review_options_popup'>
			...
			<div class="option_item" style="height: 24px;">
				...
				<span class="text overall">Booking Calendar Shortcode:</span>
					

					<input type='text' id="wpjobus_resume_booking_calendar" class='' name='wpjobus_resume_booking_calendar' style="width: 300px; float: left;" value='<?php echo $wpjobus_resume_booking_calendar; ?>' placeholder="" />
		...
		update_post_meta($td_post_id, 'wpjobus_resume_booking_calendar', $_POST['wpjobus_resume_booking_calendar']);
		update_post_meta($td_post_id, 'wpjobus_resume_publish_email', $_POST['wpjobus_resume_publish_email']);
		if($_POST['wpjobus_resume_booking_calendar'] != ""){

			$wpjobus_resume_booking_calendar_val = stripslashes($_POST['wpjobus_resume_booking_calendar']);
			...
			if(!empty($matches_val)){
				...
				update_post_meta($td_post_id, 'wpjobus_resume_booking_calendar_id',$match_get_val);
