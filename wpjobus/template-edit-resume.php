		...
		<div class="container">
			...
			<div class="resume-skills">
				...
				<form id="wpjobus-add-resume" type="post" action="" >
					...
					<h1 class="resume-section-title"><i class="fa fa-file-text-o"></i><?php _e( 'Edit Your Carer Resume', 'themesdojo' ); ?></h1>
					<h3 class="resume-section-subtitle" style="margin-bottom: 0;"><?php _e( 'Hey. It’s easier than it looks. Take a deep breath and complete the fields below. You’ll have a beautiful Carer resume page!', 'themesdojo' ); ?></h3>
